...
const menuLinks = computed(() => [
  { tab: 'wms', title: t('menuLink.dashboard'), icon: 'dashboard', link: '/wms-dashboard' },
  { tab: 'wms', title: t('menuLink.goods'), icon: 'inventory_2', link: '/goods' },
  { tab: 'wms', title: t('menuLink.bin'), icon: 'shelves', link: '/bin' },
  { tab: 'wms', title: t('menuLink.stock'), icon: 'warehouse', link: '/stock' },
  { tab: 'wms', title: t('menuLink.asn'), icon: 'move_down', link: '/asn' },
  { tab: 'wms', title: t('menuLink.asnDetail'), icon: 'playlist_add_check', link: '/asn-detail' },
  { tab: 'wms', title: t('menuLink.dn'), icon: 'move_up', link: '/dn' },
  { tab: 'wms', title: t('menuLink.dnDetail'), icon: 'playlist_remove', link: '/dn-detail' },
  { tab: 'wms', title: t('menuLink.supplier'), icon: 'local_shipping', link: '/supplier' },
